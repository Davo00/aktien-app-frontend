...
export class ApiService {
  ...
  public getGroupnameById(groupId: number): any {
    const url = this.baseUrl + '/group/' + 'name/' + groupId;
    return this.http.get(url, {headers: this.headersToken, observe: 'response'}); // this.baseUrl + url
  }
